...
void MosfetMacro(void)
{
	...
	{
		char szMsg[512];
		sprintf(szMsg, "Error:  Couldn't find the Active Contact Layer in the "
				  "TDB File.\nLayer:  \"%s\"\nPlease check the spelling and make "
				  "sure the layer exists!",  szActiveContactLayer);
	...
	{
		char szMsg[512];
		sprintf(szMsg, "Error:  Couldn't find the Active Layer in the "
				  "TDB File.\nLayer:  \"%s\"\nPlease check the spelling and make "
				  "sure the layer exists!",  szActiveLayer);
		LDialog_MsgBox(szMsg);
		return;
	}
	...
	{
		char szMsg[512];
		sprintf(szMsg, "Error:  Couldn't find the Select Layer in the "
				  "TDB File.\nLayer:  \"%s\"\nPlease check the spelling and make "
				  "sure the layer exists!",  szSelectLayer);
		LDialog_MsgBox(szMsg);
		return;
	}
	...
	{
		char szMsg[512];
		sprintf(szMsg, "Error:  Couldn't find the Polysilicon Layer in the "
				  "TDB File.\nLayer:  \"%s\"\nPlease check the spelling and make "
				  "sure the layer exists!",  szPolyLayer);
		LDialog_MsgBox(szMsg);
		return;
	}
	...
	{
		char szMsg[512];
		sprintf(szMsg, "Error:  Couldn't find the Metal1 Layer in the "
				  "TDB File.\nLayer:  \"%s\"\nPlease check the spelling and make "
				  "sure the layer exists!",  szMetal1Layer);
		LDialog_MsgBox(szMsg);
		return;
	}
