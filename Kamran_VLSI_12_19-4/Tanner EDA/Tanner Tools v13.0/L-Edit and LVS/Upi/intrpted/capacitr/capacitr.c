							 ...
							 float ATTO)
{
	...
	LDialogItem  Menu_Items[7]= {
		...
		{"Set capacitor length (0=none):", ""},
		{"Set capacitor width (0=none):", ""},
		{"Name of layer1 (top plate):", ""},
		{"Name of layer2 (bottom plate):", ""},
		{"   Inter-layer unit cap (aF/um^2):", ""},
		{"   Overlap of layer1 beyond layer2:", ""},
	};
